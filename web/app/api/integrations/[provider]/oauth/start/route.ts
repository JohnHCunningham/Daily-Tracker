...
export async function GET(
  ...
  if (provider === 'hubspot') {
    ...
    const scopes = process.env.HUBSPOT_SCOPES || 'oauth crm.objects.owners.read crm.objects.contacts.read crm.objects.companies.read crm.objects.deals.read crm.objects.calls.read'
